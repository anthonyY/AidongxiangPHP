...
class WxPayResults extends WxPayDataBase
{
     ...
     * 将xml转为array
     * @param string $xml
     * @param integer $type 1公众号 2支付宝
     * @throws WxPayException
     */
	public static function Init($xml,$type=1)
	{
		$obj = new self();
		if($type)
		{
...
class WxPayUnifiedOrder extends WxPayDataBase
{
	...
	**/
	 ...
	 * @return 值
	 **/
	public function  set_scene_info($wap_url,$wap_name)
	{
		$scene_info = ['h5_info'=>['type'=>'Wap','wap_url'=>$wap_url,'wap_name'=>$wap_name]];
		return $this->values['scene_info'] = json_encode($scene_info);
	}
