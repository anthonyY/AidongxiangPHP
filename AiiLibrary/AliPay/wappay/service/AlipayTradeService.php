...
class AlipayTradeService
{
     ...
     * @param $type 1 H5支付 2 APP支付
     * @return $response 支付宝返回的信息
     */
    function wapPay($builder, $return_url, $notify_url,$type=1)
    {
        ...
        // 首先调用支付api
        $response = $this->aopclientRequestExecute($request, true,$type);
    ...
    function writeLog($text)
    {
        ...
        //$text = characet ( $text );
        file_put_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . "./../../log_".date("Ymd").".txt", date("Y-m-d H:i:s") . "  " . $text . "\r\n", FILE_APPEND);
    }
