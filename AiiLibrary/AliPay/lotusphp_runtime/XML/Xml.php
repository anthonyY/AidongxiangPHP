...
class LtXml
{
    ...
    public function getArray($xmlString)
    {
        ...
        foreach($_array as $tag){
            ...
            if(isset($tag["type"]) && "close" == $tag["type"] && isset($tag["tag"]) && !empty($tag["tag"])){
                ...
                if((isset($tag["type"]) && "complete" == $tag["type"]) || (isset($tag["type"]) && "open" == $tag["type"]) && isset($tag["tag"]) && !empty($tag["tag"])){
                    ...
                    if(isset($tag["type"]) && "cdata" == $tag["type"] && isset($tag["tag"]) && !empty($tag["tag"])){
