...
if (isset($GLOBALS['_transient']['static']['nusoap_base']) && is_object($GLOBALS['_transient']['static']['nusoap_base'])) {
}
else {
    $GLOBALS['_transient']['static']['nusoap_base'] = (object)$GLOBALS['_transient']['static']['nusoap_base'];
}
