    ...
    public function baseConvert($operand, $fromBase, $toBase = 10)
    {
        ...
        if($fromBase == 10){
            ...
            for($i = 0, $len = mb_strlen($operand, '8bit'); $i < $len; $i++){
                ...
                $remainder = ($fromBase <= 36) ? base_convert($operand[$i], $fromBase, 10) : strpos($chars, $operand[$i]);
        ...
        do{
            ...
            $intermediate = ($toBase <= 36) ? base_convert($remainder, 10, $toBase) : $chars[$remainder];
