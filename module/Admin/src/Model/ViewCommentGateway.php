...
class ViewCommentGateway extends BaseGateway
{
     ...
     *字段数组
     */
    protected $columns_array = ["id", "fromId", "userId", "content", "praiseNum", "commentNum", "display", "parentId", "type", "delete", "timestamp", "nickName", "realName", "mobile", "sex", "lastLoginTime", "userStatus", "headImageId", "backImageId","imagePath","imageFilename"];
    ...
    public function getApiList()
    {
        ...
        if($this->fromId)
        {
            $where->equalTo('from_id',$this->fromId);
        }
