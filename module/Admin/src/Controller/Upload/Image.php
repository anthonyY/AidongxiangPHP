...
class Image
{
	 ...
	 */
	function watermark($orgin, $target = '', $mark_type = 'txt', $water_img = '', $water_txt = '', $color = '#FF0000', $font = 14, $font_type = NULL, $pos = 9, $alpha = 100, $quality = 8)
	{
		if(is_array($orgin))
		{
			extract($orgin);
        ...
        var_dump($org_info,$mark_info);exit;
		// 根据系统设置获得水印的位置
		if($pos == 0)
		{
			$pos = rand(1, 9); // 随机
